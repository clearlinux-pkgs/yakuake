...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/yakuake-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/yakuake-25.04.1.tar.xz.sig
...
%setup -q -n yakuake-25.04.1
cd %{_builddir}/yakuake-25.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747202757
mkdir -p clr-build
pushd clr-build

...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/yakuake-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/yakuake-25.04.0.tar.xz.sig
...
%setup -q -n yakuake-25.04.0
cd %{_builddir}/yakuake-25.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744951630
mkdir -p clr-build
pushd clr-build

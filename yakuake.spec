...
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/yakuake-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/yakuake-24.08.2.tar.xz.sig
...
%setup -q -n yakuake-24.08.2
cd %{_builddir}/yakuake-24.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728779794
mkdir -p clr-build
pushd clr-build

...
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/yakuake-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/yakuake-23.08.4.tar.xz.sig
...
%prep
%setup -q -n yakuake-23.08.4
cd %{_builddir}/yakuake-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707782772
mkdir -p clr-build
pushd clr-build
